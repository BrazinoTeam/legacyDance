...
class BuildARaftView: UIView {
    ...
    private (set) var contentLabel: UILabel = {
        let label = UILabel.createLabel(withText: "   Zheng gathered branches and vines to build a raft. It took some time, but he managed to create a sturdy vessel. He successfully crossed the river and continued his journey.", font: .customFont(font: .ubuntuMono, style: .regular, size: Int(16.autoSize)), textColor: .white, paragraphSpacing: 1, lineHeightMultiple: 1.4, kern: 0.64)
        return label
    }()
