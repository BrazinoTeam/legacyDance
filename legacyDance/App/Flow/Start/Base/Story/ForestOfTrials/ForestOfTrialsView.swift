//
//  ForestOfTrialsView.swift

import Foundation
import UIKit
import SnapKit

class ForestOfTrialsView: UIView {
    ...
    private func setupUI() {
        ...
        [backgrounds, btnBack, btnSwim, btnBuild, labelContainer ] .forEach(addSubview(_:))
    ...
    private func setupConstraints() {
        ...
        btnSwim.snp.makeConstraints { make in
            make.left.right.equalToSuperview().inset(16)
            make.height.equalTo(64)
            make.bottom.equalTo(safeAreaLayoutGuide.snp.bottom).offset(-12)
        }
        
        btnBuild.snp.makeConstraints { make in
            make.left.right.equalToSuperview().inset(16)
            make.height.equalTo(64)
            make.bottom.equalTo(btnSwim.snp.top).offset(-16)
        }
