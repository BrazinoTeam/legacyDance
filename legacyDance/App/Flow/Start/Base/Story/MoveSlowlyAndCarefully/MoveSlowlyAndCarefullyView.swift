...
class MoveSlowlyAndCarefullyView: UIView {
    ...
    private (set) var contentLabel: UILabel = {
        let label = UILabel.createLabel(withText: "   Zheng decided to move slowly and carefully, meticulously planning each step. He successfully crossed the path and overcame his doubts.", font: .customFont(font: .ubuntuMono, style: .regular, size: 16), textColor: .white, paragraphSpacing: 1, lineHeightMultiple: 1.4, kern: 0.64)
        return label
    }()
