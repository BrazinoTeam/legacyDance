...
class IncorrectAnswerView: UIView {
    ...
    private (set) var contentLabel: UILabel = {
        let label = UILabel.createLabel(withText: "   You chose the incorrect answer. The cliff remained unmoved, and Zheng realized he needed to try again.", font: .customFont(font: .ubuntuMono, style: .regular, size: 16), textColor: .white, paragraphSpacing: 1, lineHeightMultiple: 1.4, kern: 0.64)
        return label
    }()
    
    private (set) var btnGo: UIButton = {
        let btn = UIButton()
        btn.configureButton(withTitle: "Try again", font: .customFont(font: .mac, style: .regular, size: 20), titleColor: .cDarkRed, normalImage: .imgBtnSelect, highlightedImage: .imgBtnSelect)
    ...
    private func setupConstraints() {
        ...
        labelContainer.snp.makeConstraints { make in
            ...
            labelContainerHeightConstraint = make.height.equalTo(120).constraint
        }
